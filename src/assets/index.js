...
export const gameRules = [
  "Les cartes avec les même points de défense et d'attaque s'annuleront.",
  "Les points d'attaque de la carte attaquante se déduiront des points de vie du joueur adverse.",
